...
abstract class LPaperViewClickListener<in T, in VH> {
...
abstract class LPaperWallpaperHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
...
class CollectionHolder(itemView: View) : LPaperWallpaperHolder(itemView) {
    ...
    fun setItem(
        ...
        listener: LPaperViewClickListener<Collection, CollectionHolder>
               ) {
...
class WallpaperHolder(itemView: View, private val showFavIcon: Boolean) :
    LPaperWallpaperHolder(itemView) {
    ...
    fun setItem(
        ...
        wallpaper: Wallpaper,
        check: Boolean,
        listener: LPaperViewClickListener<Wallpaper, WallpaperHolder>
               ) {
        detailsBg?.background = null
        startLoading()
